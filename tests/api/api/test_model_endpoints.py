...
def test_SQLtarget_patch_endpoint():
    ...
    endpoint_target.update_model_endpoint(endpoint_id=mock_endpoint.metadata.uid, attributes=updated_attributes)

    # Validate that these attributes were actually updated
    endpoint = endpoint_target.get_model_endpoint(endpoint_id=mock_endpoint.metadata.uid)
