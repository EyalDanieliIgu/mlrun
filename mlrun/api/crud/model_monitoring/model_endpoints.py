...
class ModelEndpoints:
    ...
    def create_model_endpoint(
        ...
        model_endpoint_store = get_model_endpoint_store(
            project=model_endpoint.metadata.project,secret_provider=mlrun.common.schemas.secret.SecretProviderName.kubernetes,
        )
    ...
    def patch_model_endpoint(
        ...
        model_endpoint_store = get_model_endpoint_store(
            project=project,secret_provider=mlrun.common.schemas.secret.SecretProviderName.kubernetes,
        )
    ...
    def get_model_endpoint(
        ...
        model_endpoint_store = get_model_endpoint_store(
            project=project, access_key=auth_info.data_session, secret_provider=mlrun.common.schemas.secret.SecretProviderName.kubernetes,
        )
    ...
    def list_model_endpoints(
        ...
        endpoint_store = get_model_endpoint_store(
            access_key=auth_info.data_session, project=project, secret_provider=mlrun.common.schemas.secret.SecretProviderName.kubernetes,
        )
    ...
    def delete_model_endpoints_resources(project_name: str):
        ...
        # Generate a model endpoint store object and get a list of model endpoint dictionaries
        endpoint_store = get_model_endpoint_store(
            access_key=auth_info.data_session, project=project_name, secret_provider=mlrun.common.schemas.secret.SecretProviderName.kubernetes,
        )
