...
class _ModelEndpointSQLStore(_ModelEndpointStore):
    ...
    def _get_table(table_name: str, metadata: db.MetaData):
        ...
        db.Table(
            ...
            db.Column(
                model_monitoring_constants.EventFieldType.STATE, db.String(10)
            ),
            db.Column(
            ...
            db.Column(
                model_monitoring_constants.EventFieldType.MODEL, db.String(255)
            ),
            db.Column(
            ...
            db.Column(
                model_monitoring_constants.EventFieldType.LABELS, db.Text
            ),
            db.Column(
            ...
            db.Column(
                model_monitoring_constants.EventFieldType.ACTIVE, db.Boolean
            ),
            db.Column(
            ...
            db.Column(
                model_monitoring_constants.EventFieldType.CHILDREN, db.Text
            ),
            db.Column(
                model_monitoring_constants.EventFieldType.LABEL_NAMES, db.Text
            ),
            db.Column(
                model_monitoring_constants.EventFieldType.TIMESTAMP, db.DateTime
            ),
            db.Column(
