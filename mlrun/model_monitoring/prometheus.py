...
_prediction_counter: prometheus_client.Counter = prometheus_client.Counter(name="predictions_total", documentation="Counter for total predictions", registry=_registry, labelnames=['project', 'endpoint_id', 'model_name'])
_model_latency: prometheus_client.Summary = prometheus_client.Summary(name="model_latency_seconds", documentation="Summary for for model latency", registry=_registry, labelnames=['project', 'endpoint_id', 'model_name'])
...
_error_counter: prometheus_client.Counter = prometheus_client.Counter(name="errors_total", documentation="Counter for total errors", registry=_registry, labelnames=['project', 'endpoint_id', 'model_name'])
