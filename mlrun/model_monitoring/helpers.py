...
def get_connection_string(secret_provider: typing.Callable = None) -> str:
    ...
    """
    print('[EYAL]: now in get_connection_string, secret_provider is:', secret_provider)
    return (
...
def get_endpoint_record(project: str, endpoint_id: str, secret_provider: typing.Optional[typing.Callable] = None) -> dict[str, typing.Any]:
