...
#
#
# class ApplicationResultStoreType(enum.Enum):
#     """Enum class to handle the different store type values for saving a model endpoint record."""
#
#     v3io_nosql = "v3io-nosql"
#     SQL = "sql"
#
#     def to_application_result_store(
#         self,
#         project: str,
#         access_key: str = None,
#         application_result_store_connection: str = None,
#         secret_provider: typing.Callable = None,
#     ) -> ModelEndpointStore:
#         """
#         Return a ModelEndpointStore object based on the provided enum value.
...
#         """
#
#         if self.value == ApplicationResultStoreType.v3io_nosql.value:
#             pass
...
#         return SQLStore(
#             project=project,
#             sql_connection_string=application_result_store_connection,
#             secret_provider=secret_provider,
#         )
#
#         # from mlrun.model_monitoring.db.stores.sqldb.sql_application_result_store import SQLApplicationResult
#         #
#         # return SQLApplicationResult(
#         #     project=project,
#         #     sql_connection_string=application_result_store_connection,
#         #     secret_provider=secret_provider,
#         # )
...
#
#
# def get_application_result_store(
#     project: str,
#     access_key: str = None,
#     secret_provider: typing.Callable = None,
# ) -> ModelEndpointStore:
...
#
#     # Get store type value from ModelEndpointStoreType enum class
#     application_result_store_type = ApplicationResultStoreType(
#         mlrun.mlconf.model_endpoint_monitoring.store_type
#     )
#
#     # Convert into model endpoint store target object
#     return application_result_store_type.to_application_result_store(
#         project=project, access_key=access_key, secret_provider=secret_provider
#     )
#
#
# class MonitoringSchedulesStoreType(enum.Enum):
#     """Enum class to handle the different store type values for saving a model endpoint record."""
#
#     v3io_nosql = "v3io-nosql"
#     SQL = "sql"
#
#     def to_monitoring_schedule_store(
#         self,
#         project: str,
#         access_key: str = None,
#         monitoring_schedule_store_connection: str = None,
#         secret_provider: typing.Callable = None,
#     ) -> ModelEndpointStore:
#         """
#         Return a ModelEndpointStore object based on the provided enum value.
...
#         """
#
#         if self.value == MonitoringSchedulesStoreType.v3io_nosql.value:
#             pass
#             # from .kv_model_endpoint_store import KVModelEndpointStore
#             #
#             # # Get V3IO access key from env
...
#         return SQLStore(
#             project=project,
#             sql_connection_string=monitoring_schedule_store_connection,
#             secret_provider=secret_provider,
#         )
#
#     @classmethod
...
#
#
# def get_monitoring_schedules_store(
#     project: str,
#     access_key: str = None,
#     secret_provider: typing.Callable = None,
# ) -> ModelEndpointStore:
...
#
#     # Get store type value from ModelEndpointStoreType enum class
#     monitoring_schedules_store_type = MonitoringSchedulesStoreType(
#         mlrun.mlconf.model_endpoint_monitoring.store_type
#     )
#
#     # Convert into model endpoint store target object
#     return monitoring_schedules_store_type.to_monitoring_schedule_store(
#         project=project, access_key=access_key, secret_provider=secret_provider
#     )
